...
* **Multi-Channel Streaming**: Continuous 25 kHz streaming of 10 independent audio channels (8-bit PCM) alongside configuration command routing, audio signals generated by MCU
...
Directly following the channel configuration block, the code exercises target gain adjustments across the tx channels.
